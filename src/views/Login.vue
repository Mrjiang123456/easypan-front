  ...
  <div class="login-body">
    ...
    <div class="login-panel">
      <el-form
        ...
        ref="formDataRef"
      >
        <div class="login-title">Magic云盘</div>
        <!--input输入-->
        ...
        <div class="login-btn-qq" v-if="opType == 1">
          快捷登录 <img src="https://passport.baidu.com/passApi/img/bd-acc-qzone.png" @click="qqLogin" />
        </div>
      </el-form>
    </div>
    <!--发送邮箱验证码-->
...
.login-body {
  ...
  .bg {
    ...
    background-image: url("../assets/login_img02.png");
  }
  .login-panel {
    width: 430px;
    margin-right: 15%;
